...
public class WarBuilder {
    ...
    public static WebArchive buildWar() {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
                .addPackage("myQuiz.controller")
                .addPackage("myQuiz.controller.user")
                .addPackage("myQuiz.model.user")
                .addPackage("myQuiz.model.accesslog")
                .addPackage("myQuiz.service")
                .addPackage("myQuiz.util")
                .addPackage("myQuiz.util.converters")
                ...
                .addAsResource("shiro.ini", "shiro.ini")
                        // datasource
                .addAsWebInfResource(new File("src/main/webapp/WEB-INF/myQuiz-ds.xml"))
