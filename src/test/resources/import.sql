...
insert into permission (id,permission,description) values (12,'user:delete','desc');
insert into permission (id,permission,description) values (13,'user:enable','desc');
insert into permission (id,permission,description) values (14,'user:disable','desc');
insert into permission (id,permission,description) values (15,'user:unlock','desc');
insert into permission (id,permission,description) values (16,'user:list_superadmin','desc');
insert into permission (id,permission,description) values (17,'user:list_admin','desc');
insert into permission (id,permission,description) values (18,'user:list_user','desc');
insert into permission (id,permission,description) values (19,'user:list_guest','desc');
...
insert into role_permission (id_role,id_permission) values ( 1, 19);
...
insert into role_permission (id_role,id_permission) values ( 2, 15);
...
insert into role_permission (id_role,id_permission) values ( 2, 19);
...
insert into role_permission (id_role,id_permission) values ( 3, 19);
insert into role_permission (id_role,id_permission) values ( 4, 2);
insert into role_permission (id_role,id_permission) values ( 4, 4);


insert into `user`(`id`,`firstName`,`lastName`,`email`,`phone`,`username`,`password`,`enabled`,`failed_login_attempt_count`,`pwd_change_on_next_login`) values (1,'Jane','Doe','jane@super.com','2125551212','wakka','$shiro1$SHA-256$500000$no8bF4L6ou/rwcuv0/7qNw==$qOuLZWUSVBw6KJ+acoajJuDPeeoYoU33bdiYpQivvvo=',1,0,0);
insert into `user`(`id`,`firstName`,`lastName`,`email`,`phone`,`username`,`password`,`enabled`,`failed_login_attempt_count`,`pwd_change_on_next_login`) values (2,'Luigi','Bonacina','luigi.egidio.bonacina@ericsson.com','1234567890','admin','$shiro1$SHA-256$500000$yZnmkAQSFkP6MnlRAOisng==$LW6he2w5PcPhJC0CBLBtnH4QrkgxPb8Xt9/U0y0/dfc=',1,0,0);
insert into `user`(`id`,`firstName`,`lastName`,`email`,`phone`,`username`,`password`,`enabled`,`failed_login_attempt_count`,`pwd_change_on_next_login`) values (4,'Stefano','Dominioni','stefano.dominioni@ericsson.com','1234567890','estedom','$shiro1$SHA-256$500000$+K2EnfNa93+KeACrVfA/LQ==$9/CqO/KPcP3hxiHVYoBLBYOjQ/9D37F139kTPc1GPR0=',1,0,0);
