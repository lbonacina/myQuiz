...
insert into question (id,type,code,text,area,level) values (4,"one","Mana.004","Sei il Team Leader di un gruppo di supporto. Ti chiamano in quanto, a fronte di un guasto grave, il reperibile non è raggiungibile. In quale document, secondo ITIL,  trovi le istruzioni su come comportarti in questo caso?","Management",1) ;
...
insert into question (id,type,code,text,area,level) values (5,"one","Mana.005","Secondo la tua esperienza, e nel rispetto della normativa italiana sul lavoro, quanti FTE sono necessari per formare un turno settimanale di supporto in H24?","Management",1) ;
...
insert into question (id,type,code,text,area,level) values (6,"one","Mana.006","Un tecnico sta svolgendo un'attività critica che necessita di molta attenzione. Purtroppo è continuamente disturbato dalle chiamate del cliente che è molto ansioso in quanto il servizio sul quale si sta intervenendo è assai critico. Tu sei il manager del tecnico. Che fai.","Management",1) ;
...
insert into question (id,type,code,text,area,level) values (7,"one","Mana.007","Una risorsa che lavora con te, durante un'attività ha sbagliato un'operazione facendola fallire e causando parecchi problemi al ciente. Come ti comporti nei confronti del cliente?","Management",2) ;
...
insert into question (id,type,code,text,area,level) values (8,"one","Mana.008","Una risorsa che lavora con te, durante un'attività ha sbagliato un'operazione facendola fallire e causando parecchi problemi al ciente. Come ti comporti nei confronti della risorsa?","Management",2) ;
...
insert into question (id,type,code,text,area,level) values (9,"one","Mana.009","Il cliente continua a chiedere di eseguire attività che pur essendo all'interno dei limiti previsti dal contratto, fanno aumentare i costi ben al di sopra di quello che è possibile permettersi. Tu...","Management",2) ;
...
insert into question (id,type,code,text,area,level) values (10,"one","Db.001","Dummy Database Question #","Database",1) ;
insert into answer (text, correct, id_question) values ("Db.001.Answer #1",false,10) ;
insert into answer (text, correct, id_question) values ("Db.001.Answer #2",true,10) ;
insert into answer (text, correct, id_question) values ("Db.001.Answer #3",false,10) ;
insert into answer (text, correct, id_question) values ("Db.001.Answer #4",false,10) ;
insert into answer (text, correct, id_question) values ("Db.001.Answer #5",false,10) ;

insert into question (id,type,code,text,area,level) values (11,"one","Db.002","Dummy Database Question #","Database",1) ;
insert into answer (text, correct, id_question) values ("Db.002.Answer #1",false,11) ;
insert into answer (text, correct, id_question) values ("Db.002.Answer #2",true,11) ;
insert into answer (text, correct, id_question) values ("Db.002.Answer #3",false,11) ;
insert into answer (text, correct, id_question) values ("Db.002.Answer #4",false,11) ;
insert into answer (text, correct, id_question) values ("Db.002.Answer #5",false,11) ;

insert into question (id,type,code,text,area,level) values (12,"one","Db.003","Dummy Database Question #","Database",1) ;
insert into answer (text, correct, id_question) values ("Db.003.Answer #1",false,12) ;
insert into answer (text, correct, id_question) values ("Db.003.Answer #2",true,12) ;
insert into answer (text, correct, id_question) values ("Db.003.Answer #3",false,12) ;
insert into answer (text, correct, id_question) values ("Db.003.Answer #4",false,12) ;
insert into answer (text, correct, id_question) values ("Db.003.Answer #5",false,12) ;
