...
insert into question (id,type,text,id_quiz) values (3,"one","Per sviluppare un'applicazione Java è necessario utilizzare l’IDE Eclipse. Vero o Falso ?",1) ;
...
insert into possible_answer (text, correct, id_question) values ("Vero",false,3) ;
insert into possible_answer (text, correct, id_question) values ("Falso",true,3) ;
